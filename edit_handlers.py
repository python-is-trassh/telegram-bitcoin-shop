...
from keyboards import create_admin_menu, create_manage_categories_menu, create_manage_products_menu, create_manage_locations_menu
...
class EditHandlers:
    ...
    async def admin_edit_category_handler(self, callback: CallbackQuery, state: FSMContext):
    ...
    async def process_edit_category(self, message: Message, state: FSMContext):
        ...
        try:
            ...
            await self.db.update_category(category_id, name, description)
    ...
    async def admin_delete_category_handler(self, callback: CallbackQuery, state: FSMContext):
        ...
        try:
            ...
            is_physical_delete = await self.db.delete_category(category_id)
    ...
    async def admin_edit_product_handler(self, callback: CallbackQuery, state: FSMContext):
    ...
    async def process_edit_product(self, message: Message, state: FSMContext):
        ...
        try:
            ...
            await self.db.update_product(product_id, name, description, price_rub)
    ...
    async def admin_delete_product_handler(self, callback: CallbackQuery, state: FSMContext):
        ...
        try:
            ...
            is_physical_delete = await self.db.delete_product(product_id)
    ...
    async def admin_edit_location_handler(self, callback: CallbackQuery, state: FSMContext):
    ...
    async def process_edit_location(self, message: Message, state: FSMContext):
        ...
        try:
            ...
            await self.db.update_location(location_id, name, content_links)
    ...
    async def admin_delete_location_handler(self, callback: CallbackQuery, state: FSMContext):
        ...
        try:
            ...
            is_physical_delete = await self.db.delete_location(location_id)
            ...
            for category in categories:
                ...
                for product in products:
                    locations = await self.db.get_locations(product['id'], active_only=False)
