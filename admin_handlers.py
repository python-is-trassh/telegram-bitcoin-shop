...
class AdminHandlers:
    ...
    async def admin_add_promo_handler(self, callback: CallbackQuery, state: FSMContext):
    ...
    async def process_add_promo(self, message: Message, state: FSMContext):
        ...
        try:
            ...
            promo_id = await self.db.add_promo_code(
    ...
    async def admin_manage_promos_handler(self, callback: CallbackQuery, state: FSMContext):
        ...
        try:
            promos = await self.db.get_promo_codes(active_only=False)
            if not promos:
    ...
    async def admin_delete_promo_handler(self, callback: CallbackQuery, state: FSMContext):
        ...
        try:
            ...
            await self.db.deactivate_promo_code(promo_id)
    ...
    async def admin_stats_handler(self, callback: CallbackQuery, state: FSMContext):
    ...
    async def admin_view_reviews_handler(self, callback: CallbackQuery, state: FSMContext):
    ...
    async def admin_edit_about_handler(self, callback: CallbackQuery, state: FSMContext):
        ...
        try:
            current_about = await self.db.get_setting('about_text')
    ...
    async def process_edit_about(self, message: Message, state: FSMContext):
        ...
        try:
            ...
            await self.db.set_setting('about_text', new_about_text)
    ...
    async def admin_add_category_handler(self, callback: CallbackQuery, state: FSMContext):
    ...
    async def process_add_category(self, message: Message, state: FSMContext):
        ...
        try:
            category_id = await self.db.add_category(category_name)
    ...
    async def admin_add_product_handler(self, callback: CallbackQuery, state: FSMContext):
        ...
        try:
            categories = await self.db.get_categories(active_only=False)
            if not categories:
    ...
    async def admin_select_category_handler(self, callback: CallbackQuery, state: FSMContext):
    ...
    async def process_add_product(self, message: Message, state: FSMContext):
        ...
        try:
            ...
            product_id = await self.db.add_product(category_id, name, description, price_rub)
    ...
    async def admin_add_location_handler(self, callback: CallbackQuery, state: FSMContext):
        ...
        try:
            ...
            for category in categories:
                products = await self.db.get_products(category['id'], active_only=False)
    ...
    async def admin_select_product_handler(self, callback: CallbackQuery, state: FSMContext):
    ...
    async def process_add_location(self, message: Message, state: FSMContext):
        ...
        try:
            ...
            location_id = await self.db.add_location(product_id, name, content_links)
    ...
    async def admin_manage_categories_handler(self, callback: CallbackQuery, state: FSMContext):
